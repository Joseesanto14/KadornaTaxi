...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String CONFIG_COLUMN_VALOR_KM_RODADO = "valor_km_rodado";
    public static final String CONFIG_COLUMN_VALOR_HORA_ESPERA = "valor_hora_espera";
    public static final String CONFIG_COLUMN_MOTORISTA = "motorista";

    public static final String CREATE_TABLE_CONFIGURACAO = "CREATE TABLE " + TABLE_CONFIGURACAO +
            "(" + CONFIG_COLUMN_ID + " INTEGER PRIMARY KEY, " +
            CONFIG_COLUMN_VALOR_KM_RODADO + " REAL NOT NULL, " +
            CONFIG_COLUMN_VALOR_HORA_ESPERA + " REAL NOT NULL, " +
            CONFIG_COLUMN_MOTORISTA + " TEXT NOT NULL" +
        ");";
}
